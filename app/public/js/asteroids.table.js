    ...
    formatHeader: function(columnValue, columnKey, index) {
        if (columnKey === 'ad') {
            return $('<div></div>')
                ...
                .attr('title', "Апогейное расстояние равно расстоянию между дальнейшей точкой орбиты и Землёй, измеряется в астрономических единицах (ае)")
                .text(columnValue);
        }
        if (columnKey === 'q') {
            return $('<div></div>')
                .attr('data-toggle', "tooltip")
                .attr('title', "Перигейное расстояние равно расстоянию между ближайшей точкой орбиты и Землёй, измеряется в астрономических единицах (ае)")
                .text(columnValue);
        }
